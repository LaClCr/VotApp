                    ...
                    <View style={styles.textContainer}>
                        ...
                        <View>
                            ...
                            <Text style={styles.text}>
                                ...
                                {t(
                                    "La información que proporcionas al utilizar la aplicación se utiliza únicamente con el propósito de facilitar el proceso de votación y no será compartida con terceros sin tu consentimiento."
                                )}
                            </Text>
                        </View>
                        <View>
                            ...
                            <Text style={styles.text}>
                                {t(
                                    "No debes utilizar la aplicación de manera que pueda dañar, deshabilitar, sobrecargar o deteriorar el funcionamiento de la misma."
                                )}
                                {t(
                                    "No debes intentar obtener acceso no autorizado a la aplicación ni a los sistemas relacionados."
                                )}
                            </Text>
                        </View>
                        <Divider />
