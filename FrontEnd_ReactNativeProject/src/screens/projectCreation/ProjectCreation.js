...
const ProjectCreation = () => {
    ...
    const confirmDelete = (participant, index) => {
        Alert.alert(
            t("Borrar miembro"),
            t("Estás seguro de que deseas borrar el miembro") +
                ` ${participant}?`,
            [
                { text: t("Cancelar") },
                {
    ...
    const formattingName = () => {
        let projectCustomName = projectName.toLowerCase();
        projectCustomName =
    ...
    const handleCreateProject = async () => {
        if (
            ...
            if (representativeDNI.length !== 9) {
                alert(
                    t("El DNI/NIE del representante debe tener 9 caracteres.")
                );
                return;
            }
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                alert(
                    t("No puedes crear un proyecto si ya tienes uno en curso.")
                );
            } else {
                alert(
                    t(
    ...
    return (
        <ScrollView style={styles.generalContainer}>
            ...
            <Card style={[styles.card]}>
                ...
                <View style={styles.sectionInfo}>
                    <Text>
                        {t("Presiona sobre un miembro para eliminarlo")}
                    </Text>
                </View>
